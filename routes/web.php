...
Route::middleware(['auth'])->prefix('clinical')->name('clinical.')->group(function () {
    ...
    Route::patch('treatment-plan-items/{treatmentPlanItem}/notes', [TreatmentPlanItemController::class, 'updateNotes'])->name('treatment-plan-items.update-notes')->middleware('can:treatment_plans.edit');
...
Route::middleware(['auth'])->prefix('schedule')->name('schedule.')->group(function () {
    ...
    Route::get('appointments/options', [AppointmentController::class, 'options'])
        ->name('appointments.options')->middleware('can:appointments.view');
    ...
    Route::post('appointments/{appointment}/calls', [AppointmentController::class, 'logCall'])
        ->name('appointments.log-call')->middleware('can:appointments.manage');
